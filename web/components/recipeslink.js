...
const RecipesLink = () => {
  return (
    <Link href="/recipes">
      <a className="relative w-full h-12 sm:h-16 lg:h-24 my-4 flex z-10">
        <Brush
          className="w-9/12 md:w-7/12 absolute"
          src="images/recipebrush.png"
          alt="paint brush swipe used as a banner for the heading"
        />
        <h1 className="z-10 font-script text-big sm:text-huge self-center ml-1 md:ml-2">
          Recipes
        </h1>
        <h2 className="z-10 font-sans text-xxs md:text-base lg:text-xl self-end ml-2 pt-4 uppercase">
          Dig in
        </h2>
      </a>
    </Link>
